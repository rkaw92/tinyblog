...
function YAMLError(originalError){
	this.name = 'YAMLError';
	this.message = 'An error occured while loading a BlogPost from YAML input data:' + originalError;
...
YAMLPostFactory.prototype.getPost = function getPost(storedData){
	var document;
	try{
