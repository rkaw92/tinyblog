...
var JuicerTemplateEngine = require('./lib/templateEngines/JuicerTemplateEngine').JuicerTemplateEngine;
...
var templateEngine = new JuicerTemplateEngine(__dirname + '/templates');

var blog = new BlogEngine(postRepository, templateEngine);
